...
namespace ybgSub009
{
    class SQLStatement
    {
        ...
        public static string
            SelectSQL = "select car_empno,car_com,car_region,car_yyyymm_f, " +
                        "car_yyyymm_t,car_pos,car_dept,car_reason " +
                        "from ybgtinsa_car " +
                        "where car_empno = :car_empno ";

        public static string
            DeleteSQL = "delete from ybgtinsa_car where car_empno = :key1 and car_com = :key2";

        public static string
            UpdateSQL = "update ybgtinsa_car set car_empno=:car_empno,car_com=:car_com, " +
                        "car_region=:car_region,car_yyyymm_f=:car_yyyymm_f,car_yyyymm_t=:car_yyyymm_t, " +
        ...
        public static string
            InsertSQL = "insert into ybgtinsa_car" +
                        " (car_empno,car_com,car_region,car_yyyymm_f,car_yyyymm_t,car_pos,car_dept,car_reason,datesys1,datesys2,datesys3) " +
                        "values " +
                        " (:car_empno,:car_com,:car_region,:car_yyyymm_f,:car_yyyymm_t,:car_pos,:car_dept,:car_reason,sysdate,'A',:datesys3)";
