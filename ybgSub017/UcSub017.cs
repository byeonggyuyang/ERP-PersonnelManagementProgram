    ...
    public partial class UserControl1: UserControl
    {
        ...
        public void BtnSearch_Click()
        {
            ...
            try
            {
                ...
                cmd.BindByName = true;
                cmd.Parameters.Add("eval_year", OracleDbType.Varchar2).Value = "%" + q_eval_year.Text + "%";
                cmd.Parameters.Add("eval_no", OracleDbType.Varchar2).Value = "%" + q_eval_no.Text + "%";
                ...
                while (dr.Read())
                {
                    ...
                    row.Cells["eval_sdate"].Value = dr["eval_sdate"].ToString();
                    row.Cells["eval_edate"].Value = dr["eval_edate"].ToString();
        ...
        public void BtnDelete_Click()
        {
            ...
            DialogResult result = MessageBox.Show(row.Cells["eval_year"].Value +
        ...
        public void BtnSave_Click()
        {
            ...
            {
                if (row.Cells["status"].Value.Equals("")) continue;
                row.Cells["key1"].Value = row.Cells["eval_year"].Value;
                row.Cells["key2"].Value = row.Cells["eval_no"].Value;
                row.Cells["status"].Value = "";
            }
        ...
        private void Input_Validation_Check(object sender, EventArgs e)
        {
            ...
            //*---------------------------------------------------------------------------------------------------------
            if (ct_eval_edate.Text == "")
            {
                SetError(ct_eval_edate, "평가종료기간을 반드시 입력하세요", dataGridView1.SelectedRows[0], errorProvider1);
            }
            else
            {
            ...
            //*---------------------------------------------------------------------------------------------------------
            if (ct_eval_sdate.Text == "")
            {
                SetError(ct_eval_sdate, "평가가능기간을 반드시 입력하세요", dataGridView1.SelectedRows[0], errorProvider1);
            }
            else
            {
