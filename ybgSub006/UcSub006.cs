...
namespace ybgSub006
{
    public partial class UserControl1: UserControl
    {
        ...
        public UserControl1()
        {
            ...
            ct_rel_name.SelectedValueChanged += InputData_TextChanged;
            ...
            ct_rel_name.Validated += Input_Validation_Check;
        ...
        private void UserControl1_Load(object sender, EventArgs e)
        {
            ...
            Utility.SetComboWithCdnm(ct_rel_name, SQLStatement.SelectSQL_ybg_rel);

            q_bas_dept.Items.Add("");
            q_bas_pos.Items.Add("");
            ct_rel_name.Items.Add("");
        ...
        public void BtnSearch2_Click()
        {
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    row.Cells["rel_name"].Value = dr["rel_name"].ToString();
        ...
        private void Input_Validation_Check(object sender, EventArgs e)
        {
            ...
            if (ct_rel_name.Text == "")
            {
                SetError(ct_rel_name, "관계를 반드시 입력하세요", dataGridView1.SelectedRows[0], errorProvider1);
            }
            else
            {
                ResetError(ct_rel_name, errorProvider1);
            }
