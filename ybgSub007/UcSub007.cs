...
namespace ybgSub007
{
    public partial class UserControl1: UserControl
    {
        ...
        public UserControl1()
        {
            ...
            ct_edu_loe.SelectedValueChanged += InputData_TextChanged;
            ...
            ct_edu_degree.SelectedValueChanged += InputData_TextChanged;
            ct_edu_grade.TextChanged += InputData_TextChanged;
            ct_edu_gra.SelectedValueChanged += InputData_TextChanged;
            ct_edu_last.CheckedChanged += InputData_TextChanged;
            ...
            ct_edu_gradate.Validated += Input_Validation_Check;
        ...
        {
            //*---Combox 채우기-----------------------------------------------------
            Utility.SetComboWithCdnm(q_bas_dept, SQLStatement.SelectSQL_kkh_dept);
            Utility.SetComboWithCdnm(q_bas_pos, SQLStatement.SelectSQL_kkh_pos);
        ...
        public void BtnSearch2_Click()
        {
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    row.Cells["edu_last"].Value = Utility.ChangeBoolType(dr["edu_last"].ToString());
        ...
        public void BtnInsert_Click()
        {
            ...
            dataGridView1.Rows[rowIdx].Cells["edu_empno"].Value = ct_bas_empno.Text;
        ...
        public void BtnDelete_Click()
        {
            ...
            DialogResult result = MessageBox.Show(row.Cells["edu_loe"].Value +
        ...
        public void BtnSave_Click()
        {
            ...
            try
            {
                ...
                foreach (DataGridViewRow row in dataGridView1.Rows)
                {
                    ...
                    cmd.Parameters.Add("edu_entdate", OracleDbType.Varchar2).Value = (row.Cells["edu_entdate"].Value.ToString().Replace("-", ""));
                    cmd.Parameters.Add("edu_gradate", OracleDbType.Varchar2).Value = (row.Cells["edu_gradate"].Value.ToString().Replace("-", ""));
                    ...
                    cmd.Parameters.Add("edu_last", OracleDbType.Varchar2).Value = Utility.ChangeBoolType(row.Cells["edu_last"].Value, "YN");
        ...
        private void Input_Validation_Check(object sender, EventArgs e)
        {
            ...
            if (ct_edu_loe.Text == "")
            {
                SetError(ct_edu_loe, "학력구분을 반드시 선택하세요", dataGridView1.SelectedRows[0], errorProvider1);
            }
            else
            {
            ...
            //*---------------------------------------------------------------------------------------------------------
            if (Utility.Check_Date_YYYYMMDD(ct_edu_entdate.Text) == false)
            {
                SetError(ct_edu_entdate, "입학일자 날짜형태가 올바르지 않습니다.", dataGridView1.SelectedRows[0], errorProvider1);
            }
            else
            {
            ...
            //*---------------------------------------------------------------------------------------------------------
            if (Utility.Check_Date_YYYYMMDD(ct_edu_gradate.Text) == false)
            {
                SetError(ct_edu_gradate, "입학일자 날짜형태가 올바르지 않습니다.", dataGridView1.SelectedRows[0], errorProvider1);
            }
            else
            {
                ResetError(ct_edu_gradate, errorProvider1);
            }
        }
