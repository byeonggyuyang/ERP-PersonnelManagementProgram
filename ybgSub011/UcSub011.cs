...
namespace ybgSub011
{
    public partial class UserControl1: UserControl
    {
        ...
        public UserControl1()
        {
            ...
            ct_forl_score.Validated += Input_Validation_Check;
            ct_forl_acqdate.Validated += Input_Validation_Check;
            ct_forl_organ.Validated += Input_Validation_Check;
        ...
        public void BtnInsert_Click()
        {
            ...
            dataGridView1.Rows[rowIdx].Cells["forl_empno"].Value = ct_bas_empno.Text;
        ...
        public void BtnSave_Click()
        {
            ...
            try
            {
                ...
                foreach (DataGridViewRow row in dataGridView1.Rows)
                {
                    ...
                    cmd.Parameters.Add("forl_empno", OracleDbType.Varchar2).Value = row.Cells["forl_empno"].Value;
                    cmd.Parameters.Add("forl_name", OracleDbType.Varchar2).Value = row.Cells["forl_name"].Value;
            ...
            foreach (DataGridViewRow row in dataGridView1.Rows)
            {
                ...
                row.Cells["key2"].Value = row.Cells["forl_name"].Value;
                row.Cells["status"].Value = "";
            }
        ...
        private void Input_Validation_Check(object sender, EventArgs e)
        {
            ...
            //*---------------------------------------------------------------------------------------------------------
            if (ct_forl_name.Text == "")
            {
                SetError(ct_forl_name, "외국어자격명을 반드시 입력하세요", dataGridView1.SelectedRows[0], errorProvider1);
            }
            else
            {
            ...
            //*---------------------------------------------------------------------------------------------------------
            if (ct_forl_score.Text == "")
            {
                SetError(ct_forl_score, "점수를 반드시 입력하세요", dataGridView1.SelectedRows[0], errorProvider1);
            }
            else
            {
                ResetError(ct_forl_score, errorProvider1);
            }
            //*---------------------------------------------------------------------------------------------------------
            if (Utility.Check_Date_YYYYMMDD(ct_forl_acqdate.Text) == false)
            {
                SetError(ct_forl_acqdate, "취득일 날짜형태가 올바르지 않습니다.", dataGridView1.SelectedRows[0], errorProvider1);
            }
            else
            {
            ...
            //*---------------------------------------------------------------------------------------------------------
            if (ct_forl_organ.Text == "")
            {
                SetError(ct_forl_organ, "발급기관을 반드시 입력하세요", dataGridView1.SelectedRows[0], errorProvider1);
            }
            else
            {
                ResetError(ct_forl_organ, errorProvider1);
            }
            //*---------------------------------------------------------------------------------------------------------
        }
